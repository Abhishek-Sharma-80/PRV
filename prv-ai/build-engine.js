...
/* prv-ai/build-engine.js — run with: node prv-ai/build-engine.js */
const fs = require('fs');
const path = require('path');

const out = path.join(__dirname, 'intent-engine.js');
...
console.log('intent-engine.js written:', fs.statSync(out).size, 'bytes');